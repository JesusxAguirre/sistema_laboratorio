                ...
                <div class="bg-green-400 overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="p-6 sm:px-20 bg-indigo-400 border-b border-gray-200">
                        <form @submit.prevent="submit" method="post">
                            ...
                            <jet-label class="text-white" value="Conclusion hematologica" />
                            ...
                            <option value="filariasp">Filarias</option>
                            <option value="anaplasma" selected>Anaplasma </option> 
                             <option value="anaplasmagr" selected>Anaplasma GR</option>
                            <option value="babesiap" selected>Babesia </option>
                            <option value="theileria" selected>Theileria </option>
                            <option value="hepatozoon" selected>Hepatozoon </option>
                            <option value="mycoplasma" selected>Mycoplasma</option>
                            <option value="negativo" selected>Resultado Negativo</option>
                            </select>
        ...
        methods: {
            submit(){
                ...
                this.form.validar = true;
                 Inertia.post(route('Descarte.store'),this.form)                      
         },
            },
    })
